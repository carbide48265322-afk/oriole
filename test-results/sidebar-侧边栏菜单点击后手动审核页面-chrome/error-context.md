...
- Name: sidebar.spec.ts >> 侧边栏菜单点击后手动审核页面
- Location: e2e/sidebar.spec.ts:51:5
...
Expected: "http://localhost:3000/manual-review"
      ...
      - menu [ref=e11]:
        ...
        - menuitem "file-text审核任务" [ref=e16]:
          - img "file-text" [ref=e17]:
            - img [ref=e18]
          - text: 审核任务
        - menuitem "robotAI 审核" [ref=e20]:
          - img "robot" [ref=e21]:
            - img [ref=e22]
          - text: AI 审核
        - menuitem "user-switch人工复审" [active] [ref=e24]:
